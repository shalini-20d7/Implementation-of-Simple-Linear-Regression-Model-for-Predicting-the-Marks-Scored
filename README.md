...
## Algorithm
1.  Import Libraries
2. Create Dataset (Hours studied vs Marks scored)
...
7. Model Evaluation
8. Visualization
9. Predict Marks for custom input
...
```
## Output:
<img width="938" height="700" alt="Screenshot 2026-01-30 110343" src="https://github.com/user-attachments/assets/1721c430-4a1a-4513-8cf0-83ca561446d7" />
